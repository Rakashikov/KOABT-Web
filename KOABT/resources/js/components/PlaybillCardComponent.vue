    ...
    <div class="card-container">
        ...
        data-toggle="collapse" :href="'#collapse'+colapseTag" aria-expanded="false" :aria-controls="'collapse'+colapseTag">
            <div class="playbill_date border-right px-3" style="width: 160px">
                <div class=" playbill_date_day_month row mx-auto d-flex justify-content-between align-items-center">
            ...
            <div class="playbill-info px-3">
                <div class="playbill-title h3">{{ playbill.title }}</div>
                <div class="playbill-time h5">{{ playbill.time }}</div>
            </div>
        </a>
...
export default {
    ...
    data: function() {
        return {
            ...
            month: moment(this.playbill.day)
                .format("LLLL")
                .split(",")[1]
                .split(" ")[2],
            ...
            dayTime: moment(this.playbill.date)
                .format("LLLL")
                .split(",")[2],
            colapseTag: moment(this.playbill.date).format("MMDDYYHH")+this.playbill.title.replace(" ",""),
        };
    }
};
</script>
